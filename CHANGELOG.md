...
* **New Features**:
    * Added `title` parameter to `MediaPicker` for custom AppBar titles.
    * Added "All" option to media type selection (Images + Videos).
...
* **Improvements**:
    * Renamed project files to follow Dart naming conventions (`snake_case`).
